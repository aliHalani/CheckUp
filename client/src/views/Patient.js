...
export default function Patient(props) {
    ...
    const appointmentDataTableOptions = {
        ...
        customToolbar: () => {
            return (
              <AppointmentToolbar open={open} setOpen={setOpen} />
            );
          }
    };
    ...
    function addAppointment(appointment) {
        ...
        appointment.time = appointment.time.toJSON().slice(0,10).replace(/-/g,'-') + " " + appointment.time.toJSON().slice(11,19);
    ...
    return (
        <div className={classes.root}>
            ...
            <CreateAppointment clinics={clinics} open={open} setOpen={setOpen} addAppointment={addAppointment} />
        </div>
    )
}